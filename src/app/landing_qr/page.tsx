  ...
  return (
    <html lang="en">
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          *{margin:0;padding:0;box-sizing:border-box}
          ...
          .eye-lids{
            ...
            animation:eyeReveal 2.5s cubic-bezier(.16,1,.3,1) 0.8s both,
                      idleBlink 6s ease 4s infinite;
          }

          @keyframes eyeReveal{
            0%{transform:scaleY(0);opacity:0}
            25%{transform:scaleY(1.1);opacity:0.6}
            35%{transform:scaleY(0.04)}
          ...
          .iris{
            transform-origin:50% 50%;
            animation:irisLook 10s ease-in-out 3.5s infinite;
          }
          ...
          .eye::after{
            ...
            background:radial-gradient(ellipse,rgba(200,192,168,0.04) 0%,transparent 70%);
            border-radius:50%;
            animation:ambientGlow 5s ease-in-out 3s infinite;
          }
      ...
      <body>
        ...
        <div className="bg-data d1">0x4E 0x41 0x56</div>
        <div className="bg-data d2">sig::verify(hw_id) → OK</div>
        <div className="bg-data d3">53.4285°N 14.5528°E</div>
        <div className="bg-data d4">heading_offset: +2.7°</div>
        <div className="bg-data d5">sector 7G [WARN]</div>
        ...
        <div className="c">
          ...
          <div className="eye">
            <svg viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg">
              <g className="eye-lids">
                ...
                <path className="eye-stroke" style={{ strokeWidth: 1.2, opacity: 0.35 }} d="M22,58 Q48,22 100,18 Q152,22 178,58" />
                <circle className="eye-stroke" cx="100" cy="60" r="30" style={{ strokeWidth: 2 }} />
                <g className="iris">
                  <circle className="eye-fill" cx="100" cy="60" r="13" />
                  <line className="eye-stroke" x1="100" y1="45" x2="100" y2="50" style={{ strokeWidth: 1.6 }} />
                  <line className="eye-stroke" x1="100" y1="70" x2="100" y2="75" style={{ strokeWidth: 1.6 }} />
                  <line className="eye-stroke" x1="85" y1="60" x2="90" y2="60" style={{ strokeWidth: 1.6 }} />
                  <line className="eye-stroke" x1="110" y1="60" x2="115" y2="60" style={{ strokeWidth: 1.6 }} />
                  <line className="eye-stroke" x1="89.4" y1="49.4" x2="92.5" y2="52.5" style={{ strokeWidth: 1.3 }} />
                  <line className="eye-stroke" x1="110.6" y1="49.4" x2="107.5" y2="52.5" style={{ strokeWidth: 1.3 }} />
                  <line className="eye-stroke" x1="89.4" y1="70.6" x2="92.5" y2="67.5" style={{ strokeWidth: 1.3 }} />
                  <line className="eye-stroke" x1="110.6" y1="70.6" x2="107.5" y2="67.5" style={{ strokeWidth: 1.3 }} />
          ...
          <div className="frag f1">
            <span className="dim">status:</span> observing
          </div>

          <div className="frag f2">
            clearance level <span className="redact">REDACTED</span> required
          </div>

          <div className="frag f3">
            <span className="corrupt">4e6176 5369676874 2e65786500</span>
          </div>

          {/* Entry */}
          <div className="entry">
            <a href="https://t.me/echlon_bot" target="_blank" rel="noopener">
              <span>proceed</span>
